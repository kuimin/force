...
def build_rollout_context(
    ...
    # Route every scalar observation to the policy state so rollout matches the
    # feature layout used during recording/training.  Actions remain restricted
    # to position targets below.
